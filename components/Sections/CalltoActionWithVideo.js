          ...
          <Stack flex={1} spacing={{ base: 5, md: 10 }}>
            ...
            <Stack
              ...
              <Button
                ...
                fontWeight={'normal'}
                px={6}
                onClick={() => window.open("https://maps.app.goo.gl/WAN3ntzPAesjakP28", '_blank')}>
                Get Directions to SGK Contracting
              </Button>
            </Stack>
          </Stack>
          <Flex
            ...
            <Box
              ...
              <Image
                ...
                h={'100%'}
                src={
                  'https://i.pinimg.com/736x/61/9b/07/619b076d0384a12bbf3cde194870cb91.jpg'
                }
              />
            </Box>
          </Flex>
